...
class fscore : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val textScore = view.findViewById<TextView>(R.id.scoreValue)
        if (arguments != null){
            val txtHasil = arguments?.getString("SCORE")
            textScore.text = txtHasil
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment fscore.
         */
